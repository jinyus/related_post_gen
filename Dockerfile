...
RUN pacman -S --noconfirm --needed wget unzip sudo base-devel git go clang llvm ldc python python-pip ncurses gcc llvm hyperfine rustup dotnet-sdk crystal zig julia dart nodejs deno maven nim opam dune lua51 luajit luarocks libedit github-cli less
