...
# install odin
RUN wget 'https://github.com/odin-lang/Odin/releases/download/dev-2025-04/odin-ubuntu-amd64-dev-2025-04.zip' -O /home/builduser/odin.tar.gz

RUN tar -xzf /home/builduser/odin/odin.tar.gz -C /home/builduser/odin
